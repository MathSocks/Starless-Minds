...
If an argument has a default value, it will be specified using an equal sign arg3\_name: type = \<default\_value>\`.\*
...
More informations on moment.js [here](https://momentjs.com/docs/#/displaying/)_
